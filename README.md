...
本プロジェクトには、X (Twitter) / Character.AI スタイルの包括的な法的ドキュメントが含まれています。

### 📋 利用規約
- **ファイル**: [TERMS_OF_SERVICE.md](./TERMS_OF_SERVICE.md)
- **内容**: サービスの利用条件、禁止事項、免責事項、準拠法
- **URL**: `/terms`
- **特徴**:
  - DMCA準拠
  - プロバイダ責任制限法対応
...
### 📝 著作権ポリシー
- **ファイル**: [COPYRIGHT_POLICY.md](./COPYRIGHT_POLICY.md)
- **内容**: 著作権侵害の定義、削除要請方法、異議申し立てプロセス
- **URL**: `/copyright`
- **特徴**:
  - DMCA完全準拠
  - 削除要請専用窓口: copyright@persona-ai.com
  - 24時間以内の緊急対応
  - 透明性レポート（四半期ごと）
  - 公式パートナー制度
...
### 🌈 コミュニティガイドライン
- **ファイル**: [COMMUNITY_GUIDELINES.md](./COMMUNITY_GUIDELINES.md)
- **内容**: 禁止事項、推奨行動、通報システム
- **URL**: `/community`
- **特徴**:
  - 段階的措置（警告 → 一時停止 → 永久停止）
  - 通報システム: report@persona-ai.com
  - 72時間以内の対応
...
**プラットフォーム提供者としての免責**:
- プロバイダ責任制限法（日本）第3条
- DMCA Safe Harbor（米国）17 U.S.C. § 512
- 侵害を知らなかった場合の免責
- 通知受領後の速やかな削除

**3ストライクポリシー**:
```
1回目: ⚠️  警告メール送信、違反コンテンツ削除
2回目: 🚫 アカウント一時停止（7日間）
3回目: ❌ アカウント永久停止、IPブロック
```

**著作権侵害への対応フロー**:
```
削除要請受領 → 初期確認（6時間） → 審査（24時間） 
→ 削除実施 → 両者通知 → 異議申し立て期間（14日） → 最終判断
```

**連絡先**:
- 著作権侵害: copyright@persona-ai.com
- 異議申し立て: appeals@persona-ai.com
- 通報: report@persona-ai.com
- 公式パートナー申請: partners@persona-ai.com
- 一般お問い合わせ: support@persona-ai.com
