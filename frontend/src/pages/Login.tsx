...
const Login: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    // Google OAuth実装（実際の実装では Google Identity Services を使用）
    setError('Google ログインは現在準備中です');
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">Persona AI</h1>
          <p className="text-gray-600 text-lg">クリエイター向け人格AI運用プラットフォーム</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-200/50 p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-white border-2 border-gray-300 text-gray-700 py-3 px-4 rounded-xl hover:bg-gray-50 hover:border-gray-400 focus:ring-4 focus:ring-gray-200 transition-all duration-200 flex items-center justify-center font-medium shadow-sm hover:shadow-md"
            >
